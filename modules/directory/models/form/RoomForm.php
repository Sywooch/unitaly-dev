    ...
    public function rules()
    {
        return [
            [['active', 'placement_id', 'building', 'room_type_id', 'area',
                'bed',  'capacity', 'price', 'desc_short_translate', 'time'], 'required'],
            [['active', 'placement_id', 'room_type_id'], 'integer'],
            [['building', 'area', 'bed', 'capacity', 'price', 'time', 'desc_short', 
                'desc_full', 'desc_full_translate', 'desc_full_translate'], 'trim'],
            [['building', 'area', 'bed', 'capacity', 'price', 'time'], 'string', 'max' => 255],
            [['main_image'], 'file', /*'skipOnEmpty' => false,*/ 'mimeTypes'=> ['image/png', 'image/jpeg', 'image/gif'], 'wrongMimeType'=>DirectoryModule::t('themes-admin', 'IMAGE_MESSAGE_FILE_TYPES').' jpg, png, gif'],
            [['add_image'], 'file', 'mimeTypes'=> ['image/png', 'image/jpeg', 'image/gif'], 'wrongMimeType'=>DirectoryModule::t('themes-admin', 'IMAGE_MESSAGE_FILE_TYPES').' jpg, png, gif'],
