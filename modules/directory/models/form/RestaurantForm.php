...
class RestaurantForm extends Model
{
    ...
    {
        return [
            [['name', 'translationName', 'worktime', 'spellings', 'rest_net', 
                'latitude', 'longitude', 'address', 'translationWorktime', 'main_phone', 
                'add_phone', 'site', 'facebook', 'instagram'], 'trim'],
            [['translationName', 'spellings', 'rest_net', 'region_id', 'address'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'province_id' => DirectoryModule::t('restaurant', 'PROVINCE_ID')
        ];
    }
