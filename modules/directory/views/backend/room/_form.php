...
//                'key' => $formModel->image->id,
    ...
    foreach($languages as $language):?>
        <div class="row">
            <div class="col-sm-6">
                <?= $form->field($formModel, 'desc_short_translate[' . $language->id . ']', ['options' => ['class' => 'form-group']])
    ...
    foreach($languages as $language):?>
        <div class="row">
            <div class="col-sm-6">
                <?= $form->field($formModel, 'desc_full_translate[' . $language->id . ']', ['options' => ['class' => 'form-group']])
                ->widget(CKEditor::className(), [
                    'clientOptions' => [
                        'toolbarGroups' => [
                            ['name' => 'basicstyles', 'groups' => ['Bold', 'Italic']],
