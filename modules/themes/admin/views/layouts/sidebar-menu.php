            ...
            'items' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        [
                            'label' => Module::t('themes-admin', 'TourOptions'),
                            'url' => ['/directory/tour-options/index'],
                            'active'=>\Yii::$app->controller->id == 'tour-options',
                            'visible' => Yii::$app->user->can('BViewTourOptions'),
                        ],
                    ]
                ],
                [
